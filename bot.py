...
async def on_message(message):
    ...
    # Überprüft, ob zwei Namen sich lieben sollten oder nicht
        ...
        try:
            lao = ("lao", "laomedeia", "laomedeiaTRX", "sonja", "mond", "m�nchnerin", "alte")
	    ...
	    if prince in lao and princess in dice:
                await client.edit_message(tmp, '**Keine Analyse n�tig:** :heartpulse:')
	    ...
	    if prince in dice or princess in dice:
                ...
                await client.send_message(message.channel, 'Finger weg von meinem Stecher, du perverses St�ck **-Lao**')
	    if prince in lao or princess in lao:
                ...
                await client.send_message(message.channel, 'Finger weg von meiner Alten, du perverses St�ck **-Dice**')
            elif score >= 75:
                await client.edit_message(tmp, '**Analysiere Personen auf potenzielle Korpulationschancen:** :heartpulse:')
    ...
    # Postet ein süßes Bild von einem Kätzchen
        ...
        try:
            ...
            await client.send_message(message.channel, 'Imgur-Client spinnt. :(')
    # !capybara
    # Postet ein s��es Bild von einem Capybara
